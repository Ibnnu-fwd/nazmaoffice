    ...
    <div class="relative w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <header class="w-full items-center bg-white py-2 px-6 hidden sm:flex">
            ...
            <div x-data="{ isOpen: false }" class="relative w-1/2 flex justify-end relative z-20">
                ...
                <div x-show="isOpen" class="absolute w-32 bg-white overflow-y-s rounded-lg shadow-lg py-2 mt-16">
        ...
        <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
                <div class="bg-white dark:bg-gray-800 mb-4 relative shadow-md sm:rounded-lg overflow-hidden">
                    <h1 class="text-md text-center text-blue-950 pb-3 py-3">Halaman Manajemen Projek</h1>
                </div>
                                ...
                                <div class="w-full md:w-1/2">
                                    <form class="flex items-center">
                                        ...
                                        <div class="relative w-full">
                                            ...
                                            <input type="text" id="simple-search" placeholder="Cari Projek"
                                                required=""
                                    ...
                                    <tbody>
                                        <tr
                                            ...
                                            <td
                                                ...
                                                <img src="https://media.istockphoto.com/id/1498308293/id/foto/orang-orang-bisnis-india-bertemu-presentasi-di-ruang-konferensi-kantor-menunjukkan-grafik.jpg?s=612x612&w=0&k=20&c=IqRS2Z5gUT1LXht9Lxwx74lQrFB_70oUZmaIj6Jl6hI="
                                                    alt=" Front Image" class="max-h-20 w-auto mr-3">
                                            </td>
                                            <th scope="row"
                                                class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            ...
                                            <td
                                                class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                Kamis, 24 Agustus 2023</td>
                                            <td
                                                class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                Kabupaten Sleman, Yogyakarta </td>
                                            <td
                                                class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                ...
                <div id="createProductModal" tabindex="-1" aria-hidden="true"
                    class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0  z-[1055] justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] md:h-full">
                            ...
                            <form action="#">
                                <div>
                                    ...
                                    <input type="text" name="name" id="name"
                                        ...
                                        placeholder="Ketik Judul Projek" required="">
                                </div>
                                <div class="sm:col-span-2"><label for="description"
                                    ...
                                    <textarea id="description" rows="4"
                                        ...
                                        placeholder="Ketik deskripsi project"></textarea>
                                </div>
                                <div>
                                    <label for="name"
                                ...
                                <div>
                                    ...
                                    <input type="text" name="name" id="name"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                        placeholder="Ketik Lokasi Projek" required="">
                                </div>

                                <div class="mb-4">
                                    <span class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Gambar
                                        Projek</span>
