        ...
        <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
                <div class="bg-white dark:bg-gray-800 mb-4 relative shadow-md sm:rounded-lg overflow-hidden">
                    <h1 class="text-md text-center text-blue-950 pb-3 py-3">Halaman Manajemen Testimoni</h1>
                </div>
                                ...
                                <div class="w-full md:w-1/2">
                                    <form class="flex items-center">
                                        ...
                                        <div class="relative w-full">
                                            ...
                                            <input type="text" id="simple-search" placeholder="Cari Testimoni"
                                                required=""
                                        ...
                                        <tr
                                            ...
                                            <td
                                                ...
                                                <img src="https://media.istockphoto.com/id/1498308293/id/foto/orang-orang-bisnis-india-bertemu-presentasi-di-ruang-konferensi-kantor-menunjukkan-grafik.jpg?s=612x612&w=0&k=20&c=IqRS2Z5gUT1LXht9Lxwx74lQrFB_70oUZmaIj6Jl6hI="
                                                    alt=" Front Image" class="max-h-20w-auto mr-3">
                                            </td>
                                            <th scope="row"
                                                class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            ...
                                            <td
                                                ...
                                                <div class="flex items-center">
                                                    "Tim IT NaZMa sangat responsif dan selalu siap membantu kami dengan
                                                    pertanyaan atau masalah yang kami miliki. Kami sangat
                                                    merekomendasikan layanan IT mereka"
                                                </div>
                                            </td>
                                            <td
                                                class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            ...
                            <form action="#">
                                <div>
                                    ...
                                    <input type="text" name="name" id="name"
                                        ...
                                        placeholder="Ketik Nama Testimoni" required="">
                                </div>
                                <div class="sm:col-span-2"><label for="description"
                                    ...
                                    <textarea id="description" rows="4"
                                        ...
                                        placeholder="Ketik deskripsi testimoni disini"></textarea>
                                </div>


                                <div class="mb-4">
                                    <span class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Foto
                                        Testimoni</span>
