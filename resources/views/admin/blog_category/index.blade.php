<x-app-layout>
    <x-card-container page_title="Manajemen Kategori">
        <div
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left text-gray-500">
                ...
                <tbody>
                    @forelse ($blogCategories as $data)
                ...
                <form action="" method="POST">
                    ...
                    <div class="p-6 space-y-6">
                        <x-input id="title" name="title" label="Judul" type="text"
                            placeholder="Masukan judul kategori" required />
                    </div>
                    <!-- Modal footer -->
    ...
    @push('js-internal')
        <script>
            function btnEdit(id) {
                ...
                $('#modal-title').text('Formulir Edit Kategori Blog');

                $.ajax({
                    url: "{{ route('admin.blog-category.get-by-id') }}",
                    type: 'POST',
                    data: {
                        _token: '{{ csrf_token() }}',
                        id: id
            ...
            function btnDelete(id) {
                $('#delete-modal form').attr('action', "{{ route('admin.blog-category.destroy', ':id') }}".replace(':id', id));
            }
            ...
            $(function() {
                $('#btnAddCategory').click(function(e) {
                    ...
                    $('form').attr('action', url);
                    $('#modal-title').text('Formulir Tambah Kategori Blog');
                });
