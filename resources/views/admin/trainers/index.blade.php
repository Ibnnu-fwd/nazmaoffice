        ...
        <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
                <div class="bg-white dark:bg-gray-800 mb-4 relative shadow-md sm:rounded-lg overflow-hidden">
                    <h1 class="text-md text-center text-blue-950 pb-3 py-3">Halaman Manajemen Pelatih</h1>
                </div>
                                ...
                                <div class="w-full md:w-1/2">
                                    <form class="flex items-center">
                                        ...
                                        <div class="relative w-full">
                                            ...
                                            <input type="text" id="simple-search" placeholder="Cari Pelatih"
                                                required=""
                            ...
                            <form action="#">
                                <div>
                                    ...
                                    <input type="text" name="name" id="name"
                                        ...
                                        placeholder="Ketik nama pelatih disini" required="">
                                </div>
                                <div class="sm:col-span-2"><label for="description"
                                    ...
                                    <textarea id="description" rows="4"
                                        ...
                                        placeholder="Ketik Departemen disini"></textarea>
                                </div>
