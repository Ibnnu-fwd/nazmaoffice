        ...
        <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
                <div class="bg-white dark:bg-gray-800 mb-4 relative shadow-md sm:rounded-lg overflow-hidden">
                    <h1 class="text-base text-center text-blue-950 pb-3 py-3">Manajemen Blog</h1>
                </div>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <button type="button" data-modal-target="create-modal"
                                        data-modal-toggle="create-modal" id="btnAddCategory"
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="p-6 space-y-6">
                                    <x-select id="blog_category_id" name="blog_category_id" label="Kategori blog"
                                        required>
