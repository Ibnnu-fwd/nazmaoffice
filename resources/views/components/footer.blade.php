...
<footer class="bg-white mt-10">
    <div class="px-4 py-12 mx-auto max-w-7xl lg:px-12 2xl:px-0">
        <div class="grid md:grid-cols-2 gap-12 md:gap-28">
            <div>
                ...
                <div class="mb-3">
                    <h1 class="font-semibold text-xs 2xl:text-base text-black">No. Telepon Kantor</h1>
                    <p class="text-gray-400 text-xs 2xl:text-base">
                ...
                <div class="mb-3">
                    <h1 class="font-semibold text-xs 2xl:text-base text-black">No. Handphone</h1>
                    <p class="text-gray-400 text-xs 2xl:text-base">
                ...
                <div class="mb-3">
                    <h1 class="font-semibold text-xs 2xl:text-base text-black">Email</h1>
                    <p class="text-gray-400 text-xs 2xl:text-base">
            ...
            <div>
                <div class="mb-6">
                    <h1 class="font-semibold text-xs 2xl:text-base text-black">Alamat</h1>
                    @php
                    ...
                    <ul class="list-disc list-inside mt-6 list">
                        @forelse ($companyAddresses as $companyAddress)
                            <li class="md:pl-6 mb-2">
                                <span class="font-medium text-black text-xs 2xl:text-base">
                                    {{ $companyAddress->title }}
                                </span>
                                <p class="text-gray-400 pl-5 text-xs 2xl:text-base">
                ...
                <div>
                    <h1 class="font-semibold text-xs 2xl:text-base text-black">Ikut Kami</h1>
    ...
    <div class="bg-primary py-4">
        <p class="text-center text-white text-xs 2xl:text-base">
            CV. NaZMa Office. <br>
