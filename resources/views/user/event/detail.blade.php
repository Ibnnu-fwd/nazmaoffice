        ...
        <div class="relative items-center w-full px-4 lg:px-0 py-24 mx-auto max-w-3xl">
            <div class="grid items-start grid-cols-1 lg:grid-cols-2">
                ...
                <section class="flex flex-col px-6 sm:px-8 lg:py-6 bg-gray-50 rounded-2xl">
                    ...
                    @endphp
                    <button data-modal-target="registerModal" data-modal-toggle="registerModal"
                        class="items-center justify-center w-full px-6 py-2.5 mt-8 text-center text-white duration-200 bg-primary border-2 border-primary rounded-full inline-flex hover:border-primary focus:outline-none focus-visible:outline-primary text-md focus-visible:ring-primary"
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                        Formulir pendaftaran: {{ $event->title }}
                    </h3>
                    <button type="button"
                ...
                <form action="{{ route('user.register-event', $event->id) }}" method="POST">
                    <div class="p-6 space-y-6">
                        @csrf
                        <x-input label="Nama Lengkap" name="name" type="text" required />
                        <x-input label="Email" name="email" type="email" required />
                        <x-input label="No. Telepon" name="phone" type="text" required />
                        <x-input label="Organisasi/Perusahaan" name="company" type="text"
                            placeholder="Opsional" />
                        <x-input label="Jabatan" name="job_title" type="text" placeholder="Opsional" />
                    </div>
                    <!-- Modal footer -->
                    <div
                        ...
                        <button data-modal-hide="registerModal" type="button"
                            class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500">
                            Batal
                        </button>
                    </div>
                </form>
