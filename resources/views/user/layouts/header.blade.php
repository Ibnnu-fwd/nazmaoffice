...
<div class="mx-auto bg-white w-full sticky top-0 z-50">
    <div x-data="{ open: false }"
        class="relative flex flex-col w-full py-2 mx-auto bg-white md:items-center md:justify-between md:flex-row md:px-6 lg:px-8 md:max-w-7xl">
        <div class="flex flex-row items-center justify-between lg:justify-start">
            <img src="{{ asset('assets/images/logo nazma elipse -01.png') }}"
                class="rounded-full object-cover object-center w-20 h-20" />
