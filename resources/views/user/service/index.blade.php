                        ...
                        <div class="max-w-xl text-center lg:text-left" data-aos="fade-right" data-aos-duration="1000">
                            <div>
                                ...
                                <p class="max-w-xl mt-4 text-base tracking-tight text-gray-400">
                                    Kami membantu anda untuk mengembangkan bisnis anda dengan berbagai layanan yang kami
                                    miliki dan kami siap membantu anda untuk mengembangkan bisnis anda.
                                </p>
                            </div>
                        ...
                        <div class="grid grid-cols-2 gap-12 lg:grid-cols-4 lg:space-y-0">
                            <div data-aos="fade-up" data-aos-duration="1000">
                                <div>
                                    ...
                                    <p class="mt-4 text-md font-medium leading-6 text-black">
                                        Terjangkau
                                    </p>
                                </div>
